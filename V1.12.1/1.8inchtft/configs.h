#pragma once
  ...
  //// HARDWARE NAMES
    ...
    #define HARDWARE_NAME "doit_esp32"
 ...
 //// BOARD FEATURES
  ...
  //// MENU DEFINITIONS
    ...
    #define ICON_W 22
    #define ICON_H 22
    #define BUTTON_PADDING 10    // was 22 — too large for 128px screen
  #endif
