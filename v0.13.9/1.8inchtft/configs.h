...
//      #define U_BTN 32   // UP button
//      #define D_BTN 33   // DOWN button
//      #define L_BTN 25   // LEFT button
//      #define R_BTN 26   // RIGHT button
//      #define C_BTN 27   // CENTER / SELECT button
 ...
 //// BOARD FEATURES
  ...
  //// BUTTON DEFINITIONS
      ...
      // BUTTON PINS (adjusted for ESP32 DevKit + your wiring style)
      #define U_BTN 32   // UP button
      #define D_BTN 33   // DOWN button
      #define L_BTN 25   // LEFT button
      #define R_BTN 26   // RIGHT button
      ...
      // Pull configuration (ESP32 uses internal pullups)
      #define L_PULL true
      #define C_PULL true
      #define U_PULL true
      #define R_PULL true
  ...
  //// DISPLAY DEFINITIONS
    ...
    #ifdef MARAUDER_KIT   // you can rename this later to MARAUDER_ST7735
    
      #define HAS_ST7735
      #define SCREEN_CHAR_WIDTH 40   // reduced for 128px width
      ...
      // smaller status bar for small screen
      #define STATUS_BAR_WIDTH (TFT_HEIGHT/16)
    
      #define LVGL_TICK_PERIOD 6
    
      // Centered frame for small display
      #define FRAME_X 100
      #define FRAME_Y 64
      #define FRAME_W 120
      #define FRAME_H 50
